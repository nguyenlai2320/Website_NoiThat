<?php 
    session_start();
    if(isset($_POST['btn-submit-buy']) && $_POST['btn-submit-buy']){
        $cus_name = $_POST['info-ipt-name'];
        $cus_email = $_POST['info-ipt-email'];
        $cus_phone = $_POST['info-ipt-phone'];
        $cus_address = $_POST['info-ipt-address'];
        $order_price = $_POST['totalPriceOrder'];
    }
    else {
        echo 'CHƯA LẤY ĐƯỢC THÔNG TIN!';
    }
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <div class="header clearfix">
                <h3 class="text-muted" align="center"><strong>THANH TOÁN ĐƠN HÀNG BẰNG VNPAY</strong></h3>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="amount"
                               name="amount" type="number" value="<?php echo $order_price; ?>"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_billing_fullname"
                               name="txt_billing_fullname" type="text" value="<?php echo $cus_name; ?>"/>             
                    </div>
                    <div class="form-group">
                        <label >Email (*)</label>
                        <input class="form-control" id="txt_billing_email"
                               name="txt_billing_email" type="text" value="<?php echo $cus_email; ?>"/>   
                    </div>
                    <div class="form-group">
                        <label >Số điện thoại (*)</label>
                        <input class="form-control" id="txt_billing_mobile"
                               name="txt_billing_mobile" type="text" value="<?php echo $cus_phone; ?>"/>   
                    </div>
                    <div class="form-group">
                        <label >Địa chỉ (*)</label>
                        <input class="form-control" id="txt_billing_addr1"
                               name="txt_billing_addr1" type="text" value="<?php echo $cus_address; ?>"/>   
                    </div>
                    <div class="form-group">
                        <label >Mã bưu điện (*)</label>
                        <input class="form-control" id="txt_postalcode"
                               name="txt_postalcode" type="text" value="727010"/> 
                    </div>
                    <div class="form-group">
                        <label >Tỉnh/TP (*)</label>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_ship_fullname"
                               name="txt_ship_fullname" type="text" value="<?php echo $cus_name; ?>"/>
                    </div>
                    <div class="form-group">
                        <label >Email (*)</label>
                        <input class="form-control" id="txt_ship_email"
                               name="txt_ship_email" type="text" value="<?php echo $cus_email; ?>"/>
                    </div>
                    <div class="form-group">
                        <label >Số điện thoại (*)</label>
                        <input class="form-control" id="txt_ship_mobile"
                               name="txt_ship_mobile" type="text" value="<?php echo $cus_phone; ?>"/>
                    </div>
                    <div class="form-group">
                        <label >Địa chỉ (*)</label>
                        <input class="form-control" id="txt_ship_addr1"
                               name="txt_ship_addr1" type="text" value="<?php echo $cus_address; ?>"/>
                    </div>
                    <div class="form-group">
                        <label >Mã bưu điện (*)</label>
                        <input class="form-control" id="txt_ship_postalcode"
                               name="txt_ship_postalcode" type="text" value="727010"/>
                    </div>
                    <div class="form-group">
                        <label >Tỉnh/TP (*)</label>
                        <input class="form-control" id="txt_ship_city"
                               name="txt_ship_city" type="text" value="TP. Hồ Chí Minh"/>
                    </div>
                    <div class="form-group">
                        <label>Bang (Áp dụng cho US,CA)</label>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_inv_customer"
                               name="txt_inv_customer" type="text" value="<?php echo $cus_name; ?>"/>
                    </div>
                    <div class="form-group">
                        <label >Công ty</label>
                        <input class="form-control" id="txt_inv_company"
                               name="txt_inv_company" type="text" value="Công ty TNHH Một Mình Em"/>
                    </div>
                    <div class="form-group">
                        <label >Địa chỉ</label>
                        <input class="form-control" id="txt_inv_addr1"
                               name="txt_inv_addr1" type="text" value="<?php echo $cus_address; ?>"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_inv_email"
                               name="txt_inv_email" type="text" value="<?php echo $cus_email; ?>"/>
                    </div>
                    <div class="form-group">
                        <label >Điện thoại</label>
                        <input class="form-control" id="txt_inv_mobile"
                               name="txt_inv_mobile" type="text" value="<?php echo $cus_phone; ?>"/>
                    </div>
